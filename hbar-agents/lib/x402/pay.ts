...
export const HBAR_STUB_PAY_TOOL = "hbar_stub_pay";
...
export class StubPayTool extends BaseTool<StubPayParams, NormalisedParams> {
  method = HBAR_STUB_PAY_TOOL;
  name = "Pay for HBAR stub task";
  description =
...
export const hbarStubPlugin: Plugin = {
  name: "hbar-stub",
  description: "HBAR stub pay-per-call task purchase",
